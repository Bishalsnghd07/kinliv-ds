...
// Extended CartItem to include plan details
interface CartItem {
  id: string;           // product ID (e.g., "kin-ultrapower-30days")
  name: string;
  price: number;
  quantity: number;
  image?: string;
  planId: string;       // "30days", "60days", "90days"
  codShipping: number;  // shipping fee for COD (0 for online)
}
